	...
	inject() {
		...
		serverButton.on('mouseenter.HSCT', () => {
			...
			setTimeout(() => {
				...
				serverTooltip.attr('style', `left: ${center}px; top: ${(rect.top + rect.height) + 2}px; white-space: nowrap;`);
			}, 10);
